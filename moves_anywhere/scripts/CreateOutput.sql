-- https://github.com/USEPA/EPA_MOVES_Model/blob/master/database/CreateOutput.sql
...
-- ***********************************************************************************
CREATE TABLE IF NOT EXISTS translate_activitytype (
...
CREATE TABLE IF NOT EXISTS translate_avgspeedbin (
...
CREATE TABLE IF NOT EXISTS translate_county (
...
CREATE TABLE IF NOT EXISTS translate_day (
...
CREATE TABLE IF NOT EXISTS translate_engtech (
...
CREATE TABLE IF NOT EXISTS translate_fuelsubtype (
...
CREATE TABLE IF NOT EXISTS translate_fueltype (
...
CREATE TABLE IF NOT EXISTS translate_hp (
...
CREATE TABLE IF NOT EXISTS translate_nrscc (
...
CREATE TABLE IF NOT EXISTS translate_pollutant (
...
CREATE TABLE IF NOT EXISTS translate_process (
...
CREATE TABLE IF NOT EXISTS translate_regclass (
...
CREATE TABLE IF NOT EXISTS translate_roadtype (
...
CREATE TABLE IF NOT EXISTS translate_sector (
...
CREATE TABLE IF NOT EXISTS translate_sourcetype (

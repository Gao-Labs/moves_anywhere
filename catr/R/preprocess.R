preprocess = function(){
  ...
  # Should be default moves logins
  ...
  Sys.setenv(MDB_NAME=p$outputdbname) # Name of output database (moves)
  Sys.setenv(MDB_DEFAULT=p$MDB_DEFAULT) # Name of default input database (movesdb20240104)
  ...
  p$runspec = catr::custom_rs(
    .outputdbname = p$outputdbname, .inputdbname = p$inputdbname,
